...
//  WeatherGift
//
//  Created by Paige Moshier on 10/14/19.
...
class PageVC: UIPageViewController {
    ...
    func configureListButton() {
        ...
        listButton = UIButton(frame: CGRect(x: view.frame.width - barButtonWidth, y: safeHeight - barButtonWidth, width: barButtonWidth, height: barButtonHeight))
