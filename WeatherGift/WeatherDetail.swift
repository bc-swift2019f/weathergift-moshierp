...
//  WeatherGift
//
//  Created by Paige Moshier on 10/20/19.
        ...
        Alamofire.request(weatherURL).responseJSON { response in
            ...
            case .success(let value):
                ...
                for day in 1...days {
                    ...
                    let newDailyForcast = DailyForecast(dailyMaxTemp: maxTemp, dailyMinTemp: minTemp, dailyDate: dateValue, dailySummary: dailySummary!, dailyIcon: icon!)
